...
import wandb      #to view the metrics of how the training is improving the model. Navigate in  https://wandb.ai/home to see it

import argparse
import pickle     #pickle as well as Json are forms of serialize data.It is a way to convert a data structure into a linear form that can be stored or transmitted over a network.
import random
import sys

from evaluation_dt import evaluate_episode_rtg  
...
def experiment(
    ...
    dataset = variant['dataset']            #we are designing the datasets as in D4RL benchmark to train the model
    ...
    if env_name == 'env_va': 
        ...
        max_ep_len = 1000
        env_targets = [76, 40] # evaluation conditioning targets
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', type=str, default='dt')  # dt for decision transformer
    ...
    parser.add_argument('--device', type=str, default='cpu')     # I do not have NVIDIA GNU so I can not use the toolkit
